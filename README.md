...
（起因是项目甲方急要，但我自己又不想写，把文件一个一个上传给GPT又太麻烦，于是学着写了一个Agent实现这个功能。但本人只学了HelloAgent项目中Agent的经典范式(https://github.com/datawhalechina/hello-agents/blob/main/docs/chapter4)
，于是乎该项目完成的并不理想）
...
7. Kimi K2.5模型支持Json回复模式，修改提示词让kimi自动回复Json是否可以进一步优化性能？
